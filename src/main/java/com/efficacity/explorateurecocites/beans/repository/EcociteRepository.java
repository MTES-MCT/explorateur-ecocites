 ...
 */
@Repository
public interface EcociteRepository extends EcociteDefaultRepository {

    List<Ecocite> findAllByOrderByNomAsc();

    List<Ecocite> findAllByOrderByIdAsc();

    List<Ecocite> findAllByIdInOrderByNomAsc(List<Long> listeId);
}

 ...
 */
@NoRepositoryBean
public interface EcociteDefaultRepository extends JpaRepository<Ecocite, Long>, JpaSpecificationExecutor<Ecocite> {
  Optional<Ecocite> findBySiren(String siren);
}

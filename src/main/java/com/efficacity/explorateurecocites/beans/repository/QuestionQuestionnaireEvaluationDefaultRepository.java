 ...
 */
@NoRepositoryBean
public interface QuestionQuestionnaireEvaluationDefaultRepository extends JpaRepository<QuestionQuestionnaireEvaluation, Long>, JpaSpecificationExecutor<QuestionQuestionnaireEvaluation> {
}

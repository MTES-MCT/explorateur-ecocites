 ...
 */
@NoRepositoryBean
public interface AssoActionDomainDefaultRepository extends JpaRepository<AssoActionDomain, Long>, JpaSpecificationExecutor<AssoActionDomain> {
  Optional<AssoActionDomain> findByIdActionAndIdDomain(Long idAction, Long idDomain);
}

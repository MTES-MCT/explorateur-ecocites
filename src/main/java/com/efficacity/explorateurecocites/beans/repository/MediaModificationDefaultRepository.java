 ...
 */
@NoRepositoryBean
public interface MediaModificationDefaultRepository extends JpaRepository<MediaModification, Long>, JpaSpecificationExecutor<MediaModification> {
  Optional<MediaModification> findByTypeObjectAndIdObject(String typeObject, long idObject);
}

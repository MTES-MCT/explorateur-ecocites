 ...
 */
@Repository
public interface EtiquetteAxeRepository extends EtiquetteAxeDefaultRepository {
	List<EtiquetteAxe> findByIdAxe(Long idAxe);
	List<EtiquetteAxe> findByIdAxeAndIdNotIn(Long idAxe, Set<Long> idsDomains);
}

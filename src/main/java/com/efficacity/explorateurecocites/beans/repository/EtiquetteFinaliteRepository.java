 ...
 */
@Repository
public interface EtiquetteFinaliteRepository extends EtiquetteFinaliteDefaultRepository {
  List<EtiquetteFinalite> findByIdFinalite(Long idFinalite);
  List<EtiquetteFinalite> findByIdFinaliteAndIdNotIn(Long idFinalite, Set<Long> ids);
}

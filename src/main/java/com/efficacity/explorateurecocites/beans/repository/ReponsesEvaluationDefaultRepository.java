 ...
 */
@NoRepositoryBean
public interface ReponsesEvaluationDefaultRepository extends JpaRepository<ReponsesEvaluation, Long>, JpaSpecificationExecutor<ReponsesEvaluation> {
  Optional<ReponsesEvaluation> findByIdQuestionAndIdAction(Long idQuestion, Long idAction);
}

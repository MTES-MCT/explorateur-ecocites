        ...
        switch (idChamps) {
            ...
            case "siren":
                if (CustomValidator.isEmpty(value)) {
                    ...
                    errors.rejectValue("attributValue", "error.attribut.format", messages.getMessage("error.attribut.notNull", null, locale));
                }
                break;
            case "idRegion":
                if (CustomValidator.isEmpty(value)) {
            ...
            case "anneeAdhesion":
                if (CustomValidator.isEmpty(value) || !CustomValidator.isNumeric((String) value)) {
                    errors.rejectValue("attributValue", "error.attribut.notNull.annee", messages.getMessage("error.attribut.notNull.annee", null, locale));
                }
                break;

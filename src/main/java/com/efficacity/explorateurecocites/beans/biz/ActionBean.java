        ...
        switch (idChamps) {
            ...
            case "dateDebut":
                if(CustomValidator.isEmpty(value)){
                    ...
                    errors.rejectValue("attributValue","error.attribut.dateDebut.after", messages.getMessage("error.attribut.dateDebut.after", null, locale));
                }
                break;
            case "dateFin":
                if(CustomValidator.isEmpty(value)){
                   break;
                    ...
                    errors.rejectValue("attributValue", "error.attribut.dateFin.before", messages.getMessage("error.attribut.dateFin.before", null, locale));
                }
                break;
            case "latitude":
                if(CustomValidator.isEmpty(value)){
                    ...
                    errors.rejectValue("attributValue", "error.attribut.format", messages.getMessage("error.attribut.format", null, locale));
                } else if (!CustomValidator.checkRange((String)value, -90D, 90D)){
                    errors.rejectValue("attributValue", "error.attribut.range", messages.getMessage("error.attribut.range", new Object[]{"La latitude ", -90, 90}, locale));
                }
                break;
            case "longitude":
                if(CustomValidator.isEmpty(value)){
                    ...
                    errors.rejectValue("attributValue", "error.attribut.range", messages.getMessage("error.attribut.range", new Object[]{"La longitude ", -180, 180}, locale));
                }
                break;
            case "description":
                if(CustomValidator.isEmpty(value)){
                    ...
                    errors.rejectValue("attributValue","error.technical", messages.getMessage("error.technical", null, locale));
                }
                break;
            case "etatAvancement":
                if(CustomValidator.isEmpty(value)){

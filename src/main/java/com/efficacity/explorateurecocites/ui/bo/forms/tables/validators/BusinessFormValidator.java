    ...
    public void validate(final Object o, final Errors errors) {
        ...
        if (form.getDateDebut() != null && !form.getDateDebut().trim().isEmpty()) {
            try {
                ...
                errors.rejectValue("dateDebut", "error.attribut.format", "Veuillez v\u00E9rifier le format");
            }
        }
        if (form.getDateFin() != null && !form.getDateFin().trim().isEmpty()) {
            try {
                ...
                errors.rejectValue("dateFin", "error.attribut.format", "Veuillez v\u00E9rifier le format");
            }
        }

        ...
        if (adresse != null) {
            try {
                ...
                if (shouldSendEmail(adresse)) {
                    LOGGER.info("Un email a ete envoye a {} avec pour objet : {} ", adresse, messageSubject);
                    mailer.send();
                } else {
                    LOGGER.info("Un email aurait du (filtre) etre envoye a {} avec pour objet : {} ", adresse, messageSubject);
                }

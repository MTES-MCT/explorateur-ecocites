...
public class SimpleExcelImporter {
    ...
    public ImportResponse upload(final Sheet worksheet, final ImportResponse rapport) {
        ...
        readWorksheet(worksheet, rapport);
        ...
        if (Boolean.TRUE.equals(rapport.successful())) {
     ...
     * @param rapport importResponse
     */
    private void readWorksheet(Sheet worksheet, ImportResponse rapport) {

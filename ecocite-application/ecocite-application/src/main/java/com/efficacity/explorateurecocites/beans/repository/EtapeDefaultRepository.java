 ...
 */
@NoRepositoryBean
public interface EtapeDefaultRepository extends JpaRepository<Etape, Long>, JpaSpecificationExecutor<Etape> {
  Optional<Etape> findByIdObjetAndCodeEtapeAndTypeObjet(Long idObjet, String codeEtape, String typeObjet);
}

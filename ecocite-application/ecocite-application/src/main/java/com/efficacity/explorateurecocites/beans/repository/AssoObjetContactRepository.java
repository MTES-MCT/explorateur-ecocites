 ...
 */
@Repository
public interface AssoObjetContactRepository extends AssoObjetContactDefaultRepository {
    public List<AssoObjetContact> findAllByTypeObjetAndIdObjetOrderByIdContactAsc(String typeObjet, Long idObjet);
}

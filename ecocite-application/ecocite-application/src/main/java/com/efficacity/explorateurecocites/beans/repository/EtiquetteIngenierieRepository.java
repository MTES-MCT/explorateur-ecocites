 ...
 */
@Repository
public interface EtiquetteIngenierieRepository extends EtiquetteIngenierieDefaultRepository {
  List<EtiquetteIngenierie> findByIdIngenierie(Long idIng);
  List<EtiquetteIngenierie> findByIdIngenierieAndIdNotIn(Long idIng, Set<Long> ids);
}

            ...
            <div id="contenuBo">
                <div class="row">
                    <div class="col-6 head my-4">
                        <h2 class="ft-700">Rapport action</h2>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-lg-4">
                        <label for="download_action_filter"><strong>Action</strong></label><br/>
                        <select class="form-control" id="download_action_filter">
                        </select>
                    </div>
                    <div class="col-lg-4">
                ...
                <div id="no_download" align="center" style=" display: none">
                    <span style="color: red">Vous ne pouvez pas télécharger de rapport d'action.</span>
                </div>
            </div>
        </main>
    </div>
...
<script src="/js/bo/rapports_actions.js"></script>

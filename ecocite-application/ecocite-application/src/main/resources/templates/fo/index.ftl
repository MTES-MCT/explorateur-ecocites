...
<body>
<nav id="navbar-top-home gouvernement" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div id="navbar-header-top-home" class="navbar-header row">
        <img class="gouvernement" src="/img/backgrounds/bloc_marque_ministere.svg">
    </div>
    <div class="text-parent">
        <div class="d-block">
            <h1 class="text-style">Explorateur <span class="couleur-eco">Éco</span>Cités</h1>
            <h3 class="text-style">Innovations Urbaines</h3>
        </div>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="float: right;">
        <ul class="nav navbar-nav">
            <li class="navbar-learn-more">
                <a href="http://www.ecocites.logement.gouv.fr/" class="link-with-icon--navbar navbar-learn-more"
                   target="_blank"
            ...
            <li class="">
                <a onclick="scrollToSection('#map-section');" href="#map-section"
                   class="link-with-icon--navbar navbar-button"
                   id="scroll-map">
    ...
    <section id="home" class="row ecocite-hero--home" style="background-position: right 80px;">
        <div class="home-background">
            <header class="ecocite-logo-wrapper--hero header-background">
                <div class="row">
                    <div class="col-md-1 col-sm-2 col-xs-2 logo-top-left-inv-av mariane">
                        <img src="/img/backgrounds/investir_l'avenir.png" style="" alt="investir l'avenir">
                    </div>

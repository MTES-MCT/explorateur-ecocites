...
<div class="row align-items-center">
    ...
    <div class="col-lg-6 col-xl-6 col-10">
        <div class="head">
            ...
            <#if indicateurLectureSeule?? && !indicateurLectureSeule>
        ...
        <div class="container-fluid row bg-grey-light m-r-0 m-l-0">
            <#if type_indicateur?? && type_indicateur != "indicateurOngletRealisation">
                <div class="col-lg-3 col-12 noBorder">
                    <select id="filtreObjectif"  name="filtreObjectif" class="form-control" onchange="onChangeFiltre('${ecociteId!?c}', '${type_indicateur!}')">
            ...
            <div class="col-lg-3 col-12 noBorder">
                <select name="filtreDomaine" id="filtreDomaine" class="form-control" onchange="onChangeFiltre('${ecociteId!?c}', '${type_indicateur!}')">
...
<div class="body flex-column flex-lg-row" id="indicateurListe">
    ...
    <#if indicateurLectureSeule?? && !indicateurLectureSeule>
        <div class="col-lg-4 col-12">
            ...
            <div class="content" id="listeIndicateurFiltreeEcocite">
                <#include "../../components/listeIndicateurs.ftl" />
            </div>
        </div>
        <div class="col-lg-4 col-12" id="indicateurDescription"></div>
        <div class="col-lg-4 col-12 no-border">
    <#else>
        <div class="col-lg-6 col-6 offset-lg-3 offset-3 no-border">
    </#if>
        <#if indicateurLectureSeule?? && !indicateurLectureSeule>
            <div class="title-container">
                <div class="title">
        ...
        <div id="assoIndicateurEcocite" class="content">
            <#if (listAssoIndicateurEcocite?? && listAssoIndicateurEcocite?size >0)>
                 <#list listAssoIndicateurEcocite as assoIndicateurEcociteBean>
                    <#if assoIndicateurEcociteBean??>
                        <#assign assoIndicateurEcocite = assoIndicateurEcociteBean >
                        <#include "indicateurAjout.ftl">
                    </#if>
                </#list>
            </#if>
        </div>
        <div id="assoIndicateurEcociteCommentaire" class="content">
            ...
            <textarea class="form-control commentaire" id="indicateurCommentaire" rows="3" <#if indicateurLectureSeule?? && indicateurLectureSeule>disabled</#if>>  </textarea>
            ...
            <#--</div>-->
            <div class="row m-t-10">
                <#if canEdit?? && canEdit && indicateurLectureSeule?? && !indicateurLectureSeule>
                    <#if canSubmitIndicateurs>
                        <button id="button-submit-indic" type="button" class="btn btn-lg btn-primary btn-block" data-toggle="modal" data-target="#confirmationValidationCategorisationIndicateur">
                            Validation de la saisie
                        </button>
                    <#else>
                        <button id="button-submit-indic" type="button" class="btn btn-lg btn-primary btn-block" data-toggle="modal" data-target="#modalCategorisationIndicateurNonComplete" >
                            Validation de la saisie
                        </button>
                    </#if>
    ...
    <input type="hidden" value="${ecociteId?c}" id="ecociteId">
    <input type="hidden" value="${ecociteId?c}" id="objectId">

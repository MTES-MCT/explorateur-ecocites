        ...
        if (form != null && !bindingResult.hasErrors()) {
            try {
                ...
                if (!bindingResult.hasErrors()) {
                    bindingResult.reject(ApplicationConstants.ERROR_TECHNICAL, messageSourceService.getMessageSource().getMessage(ApplicationConstants.ERROR_TECHNICAL, null, locale));
                }

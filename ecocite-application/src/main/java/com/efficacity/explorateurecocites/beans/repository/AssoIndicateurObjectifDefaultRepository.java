 ...
 */
@NoRepositoryBean
public interface AssoIndicateurObjectifDefaultRepository extends JpaRepository<AssoIndicateurObjectif, Long>, JpaSpecificationExecutor<AssoIndicateurObjectif> {
}

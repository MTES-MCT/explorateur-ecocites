 ...
 */
@Repository
public interface BusinessRepository extends BusinessDefaultRepository {
    public List<Business> findByIdAction(Long id);
    public List<Business> findByIdActionOrderByIdAsc(Long id);
    public List<Business> findAllByOrderByIdAsc();

 ...
 */
@NoRepositoryBean
public interface ReponsesQuestionnaireEvaluationDefaultRepository extends JpaRepository<ReponsesQuestionnaireEvaluation, Long>, JpaSpecificationExecutor<ReponsesQuestionnaireEvaluation> {
}

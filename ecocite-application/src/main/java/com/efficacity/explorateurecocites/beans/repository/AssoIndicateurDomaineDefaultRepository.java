 ...
 */
@NoRepositoryBean
public interface AssoIndicateurDomaineDefaultRepository extends JpaRepository<AssoIndicateurDomaine, Long>, JpaSpecificationExecutor<AssoIndicateurDomaine> {
}
